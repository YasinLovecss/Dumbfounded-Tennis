...
function(a, b) {
	...
	var c = function(a, b) {
		...
		h = function(b) {
			if (!a.gestures.stoped && a.gestures.touch) {
		...
		v = {
			...
			_initPocket: function() {
				...
				a.down && a.down.hasOwnProperty("callback") && (this.topPocket = this.scroller.querySelector("." + d), this.topPocket || (this.topPocket = this._createPocket(d, a.down, s), this.wrapper.insertBefore(this.topPocket, this.wrapper.firstChild)), this.topLoading = this.topPocket.querySelector("." + g), this.topCaption = this.topPocket.querySelector("." + h)), a.up && a.up.hasOwnProperty("callback") && (this.bottomPocket = this.scroller.querySelector("." + e), this.bottomPocket || (this.bottomPocket = this._createPocket(e, a.up, t), this.scroller.appendChild(this.bottomPocket)), this.bottomLoading = this.bottomPocket.querySelector("." + g),
					this.bottomCaption = this.bottomPocket.querySelector("." + h), this.wrapper.addEventListener("scrollbottom", this))
			},
...
function(a, b, c, d) {
	var e = "mui-visibility",
		...
		g = a.Scroll.extend(a.extend({
			...
			resetPosition: function(a) {
				return this.pulldown && this.y >= this.options.down.height ? (this.pulldownLoading(d, a || 0), !0) : this._super(a)
			},
			...
			refresh: function(a) {
				a && this.finished && (this._initPullupRefresh(), this.bottomPocket.classList.remove(f), this._setCaption(this.options.up.contentdown), this.wrapper.addEventListener("scrollbottom", this), this.finished = !1), this._super()
			}
		}, a.PullRefresh));
		...
		n = a.Scroll.extend({
			...
			_initEvent: function() {
				...
				b._super(), b.wrapper.addEventListener("swiperight", a.stopPropagation), b.wrapper.addEventListener("scrollend", function() {
					b.isInTransition = !1;
					b.currentPage;
					b.slideNumber = b._fixedSlideNumber(), b.loop && (0 === b.slideNumber ? b.setTranslate(b.pages[1][0].x, 0) : b.slideNumber === b.itemLength - 3 && b.setTranslate(b.pages[b.itemLength - 2][0].x, 0)), b.lastSlideNumber != b.slideNumber && (b.lastSlideNumber = b.slideNumber, a.trigger(b.wrapper, "slide", {
	...
	if (a.os.plus && a.os.android) {
		var c = "mui-plus-pullrefresh",
			...
			k = a.Class.extend({
				...
				refresh: function(a) {
					a && this.finished && (this._initPullupRefresh(), this.bottomPocket.classList.remove(e), this.pullCaption.className = g + " " + h, this.pullCaption.innerHTML = this.options.up.contentdown, window.addEventListener("dragup", this), this.finished = !1)
				}
			}, a.PullRefresh));
		a.fn.pullRefresh = function(d) {
			...
			return h ? f = a.data[h] : (h = ++a.uuid, e.setAttribute("data-pullrefresh-plus-" + g, h), b.body.classList.add(c), a.data[h] = f = new k(e, d)), d.up && d.up.auto && f.pullupLoading(), f
		}
	}
}(mui, document),
function(a, b, c, d) {
...
function(a, b) {
	var c = "mui-action",
		d = function(a, b) {
			return b.className && ~b.className.indexOf(c) ? (b.classList.contains("mui-action-back") && a.preventDefault(), b) : !1
		};
	a.registerTarget({
		name: b,
		index: 50,
...
function(a, b, c) {
	...
	b.addEventListener("tap", function(b) {
		if (e) {
			...
			if (f.contains("mui-collapse") && !e.parentNode.classList.contains("mui-unfold")) {
				if (H.test(b.target.tagName) || b.detail.gesture.preventDefault(), !f.contains(g)) {
					var l = e.parentNode.querySelector(".mui-collapse.mui-active");
